export default function Home() {
  return (
    <main className="min-h-dvh bg-slate-50 text-slate-800">
      ...
      <section className="bg-gradient-to-br from-teal-600 to-cyan-500 text-white">
        <div className="mx-auto max-w-6xl px-4 py-14 sm:py-20">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            <a
              href="/directory"
              className="inline-flex justify-center items-center rounded-lg bg-white text-teal-700 px-4 py-2 font-medium hover:bg-white/90"
            >
              Browse directory
            </a>
            <a
              href="/contact"
              className="inline-flex justify-center items-center rounded-lg ring-1 ring-white/70 px-4 py-2 font-medium hover:bg-white/10"
            >
              List your business
            </a>
          </div>
      ...
      {/* Quick Links */}
      <section className="mx-auto max-w-6xl px-4 -mt-8 sm:-mt-10 pb-14">
...
function Card({
  ...
  return (
    <a
      href={href}
      className="group rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 hover:shadow-md hover:ring-teal-200 transition block"
    >
