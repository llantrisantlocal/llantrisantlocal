...
type TileProps = {
  href: string;
  title: string;
  img: string;     // base path (no extension, e.g. "/tiles/aircon")
  fallback: string; // solid colour fallback
};

// Helper: prefer .jpeg, fallback to .jpg
function resolveImage(base: string) {
  ...
  return (
    <Link
      ...
      style={{
        ...
        borderRadius: 12,
        overflow: "hidden",
        background: fallback, // default background
        color: "white",
        textDecoration: "none",
      }}
    >
